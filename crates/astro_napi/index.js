...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./astro.android-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./astro.android-arm-eabi.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      if ((process.config && process.config.variables && process.config.variables.shlib_suffix === 'dll.a') || (process.config && process.config.variables && process.config.variables.node_target_type === 'shared_library')) {
        try {
          return require('./astro.win32-x64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./astro.win32-x64-msvc.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
      ...
      try {
        return require('./astro.win32-ia32-msvc.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./astro.win32-arm64-msvc.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    try {
      return require('./astro.darwin-universal.node')
    } catch (e) {
      loadErrors.push(e)
    }
    try {
    ...
    if (process.arch === 'x64') {
      try {
        return require('./astro.darwin-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./astro.darwin-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      try {
        return require('./astro.freebsd-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./astro.freebsd-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      if (isMusl()) {
        try {
          return require('./astro.linux-x64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./astro.linux-x64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
      ...
      if (isMusl()) {
        try {
          return require('./astro.linux-arm64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./astro.linux-arm64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
      ...
      if (isMusl()) {
        try {
          return require('./astro.linux-arm-musleabihf.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./astro.linux-arm-gnueabihf.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
      ...
      if (isMusl()) {
        try {
          return require('./astro.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./astro.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
      ...
      if (isMusl()) {
        try {
          return require('./astro.linux-riscv64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./astro.linux-riscv64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
      ...
      try {
        return require('./astro.linux-ppc64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./astro.linux-s390x-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./astro.openharmony-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./astro.openharmony-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./astro.openharmony-arm.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasi')) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate('./astro.wasi.cjs', false, ['./astro.wasm32-wasi.debug.wasm', './astro.wasm32-wasi.wasm'])
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        wasiBinding = require('./astro.wasi.cjs')
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasi')) {
    ...
    let candidateFailed = false
    try {
      candidateError = __napiWasiResolveCandidate('@astrojs/compiler-binding-wasm32-wasi', true, undefined)
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        if (process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          const bindingPackageVersion = require('@astrojs/compiler-binding-wasm32-wasi/package.json').version
...
const { CompactOptions, compileAstro, compileAstroSync, DiagnosticSeverity, extractStylesSync, parseAstro, parseAstroSync, ScopedStyleStrategy, SourcemapOption } = nativeBinding
export { CompactOptions }
export { compileAstro }
...
export { ScopedStyleStrategy }
export { SourcemapOption }
